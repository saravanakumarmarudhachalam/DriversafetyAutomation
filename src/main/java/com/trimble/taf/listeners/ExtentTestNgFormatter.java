...
import com.trimble.taf.testng.EmailReporter;
import com.trimble.taf.testng.NodeName;
 ...
 */
public class ExtentTestNgFormatter implements ISuiteListener, ITestListener,
	IInvokedMethodListener, IReporter
{
	...
	if (iInvokedMethod.isTestMethod())
	{
		...
		//addScreenCaptureFromPath(iTestResult, CaptureScreenshot.captureScreen("MyRport"));
	    }
	    else
	    {
		test.skip("Skipped");
    ...
    public void generateReport (List<XmlSuite> list, List<ISuite> list1,
	    String s)
    {
