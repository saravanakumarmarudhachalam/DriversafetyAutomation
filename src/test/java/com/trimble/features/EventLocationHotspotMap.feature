...
Feature: Event Location Hotspot Map
  ...
  @Regression
  Scenario: Event Location Hotspot Map - Verify the dashboard is set to display data for Last '30' Days by default
  ...
  @Regression
  Scenario: Event Location Hotspot Map - Verify that Most Dangerous Locations dashboard shows the top 10 dangerous locations with the location having highest number of Total Events at the top of the list
